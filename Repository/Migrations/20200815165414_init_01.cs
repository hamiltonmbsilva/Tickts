        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    solicitante = table.Column<string>(maxLength: 255, nullable: false),
                    data_cadastro = table.Column<DateTime>(nullable: false),
                    status = table.Column<int>(nullable: false),
                    texto_solicitacao = table.Column<string>(maxLength: 1000, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_solitacao", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    data_andamento = table.Column<DateTime>(nullable: false),
                    Solicitacao_id = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_andamento", x => x.id);
                    table.ForeignKey(
                        name: "FK_andamento_solitacao_Solicitacao_id",
                        column: x => x.Solicitacao_id,
                        principalTable: "solitacao",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_andamento_Solicitacao_id",
                table: "andamento",
